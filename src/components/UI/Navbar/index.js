  ...
  return (
    <NavbarWrapper ref={nav}>
      ...
      <NavbarContent>
        ...
        <div className='title'>{"VFloors360"}</div>
        <div
          style={{
            padding: "12px 24px",
            display: "flex",
        ...
        <Contacts>
          <h2>{"Contact Us"}</h2>
          <a className='contact-item' href='mailto:khalidsyfullah@gmail.com'>
            <img src='/assets/images/email.svg' alt='Email' />
            <span>khalidsyfullah@gmail.com</span>
          </a>
